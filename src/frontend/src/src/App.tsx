...
const bottomNavItems = [
  ...
  { id: "hr" as Page, icon: Users, label: "HR" },
  { id: "loans" as Page, icon: BookOpen, label: "Loans" },
  { id: "accounting" as Page, icon: BookOpen, label: "Accounts" },
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        />
        <main className="flex-1 overflow-auto bg-background p-3 sm:p-4 md:p-6 pb-20 md:pb-6">
        ...
        <footer className="hidden md:flex bg-card border-t border-border px-6 py-3 items-center justify-between text-xs text-muted-foreground">
          <span>
            © {new Date().getFullYear()}. Built with love using uparjanam
          </span>
      ...
      <nav
        ...
        className="md:hidden fixed bottom-0 left-0 right-0 bg-card border-t border-border z-40 flex items-stretch"
      >
