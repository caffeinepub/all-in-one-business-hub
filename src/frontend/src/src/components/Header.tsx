...
import { Bell, Check, ChevronDown, LogOut, Menu, Settings } from "lucide-react";
...
export default function Header({
  ...
  return (
    <>
      <header className="bg-card border-b border-border px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-between flex-shrink-0 gap-2">
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <h1 className="text-lg sm:text-2xl font-semibold text-foreground tracking-tight truncate max-w-[160px] sm:max-w-none">
            {title}
          </h1>
        </div>
      ...
      <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
        <SheetContent
          side="left"
          className="p-0 w-64 sidebar-gradient border-r-0"
