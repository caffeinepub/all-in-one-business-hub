...
export interface backendInterface {
    ...
    updateEmployee(id: bigint, name: string, email: string, department: string, role: string, salary: number, status: string): Promise<void>;
    ...
    addLoanDocument(loanId: bigint, name: string, fileType: string, blobRef: Uint8Array): Promise<bigint>;
    getLoanDocuments(loanId: bigint): Promise<Array<LoanDocument>>;
    deleteLoanDocument(docId: bigint): Promise<void>;
